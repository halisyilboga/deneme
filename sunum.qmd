...
format:
  revealjs:
    ...
    chalkboard: true
    preview-links: auto
    logo: images/ouroboros_generated.png
    transition: slide
    width: 1920
    height: 1080
    margin: 0.05
...
title-slide-attributes:
  data-background-image: images/ouroboros_generated.png
  data-background-size: contain
  data-background-opacity: "0.2"
lang: tr
---

![Dijital Ouroboros](images/ouroboros_generated.png){style="transform: scale(1.5);"}
...
![İlk bakışta gördüğümüz sadelik (Abstraction)](images/magic_is_engineering.png){width=60%}

![Aslında arka planda çalışan mühendislik](images/magic_is_engineering_v2.png){.fragment .fade-in width=90%}
:::
...
![Web Mimarisi Evrimi Timeline](images/diagram_01_timeline_evolution.png){style="transform: scale(1.5);"}
...
![Karmaşıklık orada bir yerde](images/complexity_conservation_v2.png){style="transform: scale(1.5);"}
...
![Karmaşıklık orada bir yerde](images/complexity_conservation.png){style="transform: scale(1.5);"}
...
![Karmaşıklık Eğrisi](images/diagram_07_complexity_curve.png){width="85%" fig-align="center"}
...
![JSF Lifecycle Faz Akışı](images/jsf_lifecycle_phases.png){style="transform: scale(1.5);"}

---

#### Detaylı Görsel

![JSF Lifecycle Faz Akışı detaylı](images/jsf_lifecycle_phases_v2.png){style="transform: scale(1.5);"}  
...
![Component Tree Yapısı ](images/component_tree_uiviewroot_v2.png){style="transform: scale(1.5);"}
...
![Component Tree Yapısı](images/component_tree_uiviewroot.png){style="transform: scale(1.5);"}
...
![RSC Class Diyagramı](images/diagram_04_rsc_class.png){style="transform: scale(1.5);"}
...
![Component Tree Evrimi](images/11_component_tree_evolution.png){style="transform: scale(1.5);"}
...
![PrimeFaces jQuery Üretimi](images/primefaces_jquery_generation.png){width="100%" style="margin-top: 0; margin-left: 0px;; transform: scale(1.5);"}

---

![PrimeFaces jQuery Üretimi (v2)](images/primefaces_jquery_generation_v2.png){width="200%" style="margin-top: 0; margin-left: -50px;; transform: scale(1.5);"}
...
![Renderer Mekanizması](images/diagram_06_renderer.png){style="transform: scale(1.5);"}
...
![PrimeFaces theme](images/primefacestheme.png){width="100%" style="margin-top: 0; margin-left: 0px;; transform: scale(1.5);"}
...
![12 Dosya vs 3 Dosya](images/file_explosion.png){style="transform: scale(1.5);"}

---

![12 Dosya vs 3 Dosya detaylı](images/file_explosion_v2.png){style="transform: scale(1.5);"}  
...
![Simple vs Complex Code](images/comparison_save_user.png){style="transform: scale(1.5);"}
...
![Declarative vs Imperative Code](images/comparison_datatable.png){style="transform: scale(1.5);"}
...
![What vs How Code](images/comparison_ajax.png){style="transform: scale(1.5);"}
...
![Buzdağı Analizi](images/glue_code_iceberg.png){style="transform: scale(1.5);"}
![Buzdağı Analizi (v2){style="transform: scale(1.5);"}](images/glue_code_iceberg_v2.png){style="transform: scale(1.5);"}  
...
![Sarkaç Eve Döndü](/images/pendulum_returns.png){style="transform: scale(1.5);"}
...
![History Repeats Code](images/comparison_server_action.png){style="transform: scale(1.5);"}
...
![N+1 Query Problemi](/images/n_plus_one_problem.png){style="transform: scale(1.5);"}

![N+1 Query Problemi](images/08_n_plus_one.png){style="transform: scale(1.5);"}


**Senaryo**: 100 kullanıcı listesi, her birinin departmanı gösterilecek.

![N+1 Problem Karşılaştırması](images/diagram_08_n_plus_one.png){style="transform: scale(1.5);"}
...
![Veri Yoğunluğu vs Etkileşim](images/diagram_09_data_intensity.png){style="transform: scale(1.5);"}
...
![Waterfall Karşılaştırması](images/waterfall_comparison.png){style="transform: scale(1.5);"}


![Waterfall Karşılaştırması](/images/diagram_12_waterfall_comparison){style="transform: scale(1.5);"}
...
![Data Proximity Diagramı](images/13_data_proximity.png){style="transform: scale(1.5);"}
...
![Best Practices Karşılaştırması](images/diagram_14_best_practices.png){style="transform: scale(1.5);"}

![Best Practices Karşılaştırması](/images/best_practices_comparison.png){style="transform: scale(1.5);"}
...
![Karar Ağacı](images/diagram_10_decision_tree.png){style="transform: scale(1.5);"}
...
![Mimari Sarkaç](images/diagram_03_pendulum.png){style="transform: scale(1.5);"}
...
![Spiral Yükseliş](images/diagram_15_spiral_ascent.png){style="transform: scale(1.5);"}

![Spiral Yükseliş](/images/spiral_ascent_final.png){style="transform: scale(1.5);"}
<!-- ⚠️ EKSİK GÖRSEL: Bu dosya henüz oluşturulmamış -->
